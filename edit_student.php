...
<head>
    ...
    <title>Edit Student - AcademyPro</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (empty($name) || empty($age) || empty($email)) {
                ...
                $sql = "UPDATE student SET name = ?, age = ?, email = ? WHERE student_id = ?";
                $stmt = mysqli_prepare($conn, $sql);
                mysqli_stmt_bind_param($stmt, "siii", $name, $age, $email, $student_id);
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="number" id="age" name="age" min="16" value="<?php echo $student['age']; ?>" required>
            </div>
            ...
            <div class="button-group">
                ...
                <button type="submit" name="delete" class="delete-btn" onclick="return confirm('Are you sure you want to delete this student?');">🗑️ Delete Student</button>
            </div>
        </form>
    </div>
</body>
